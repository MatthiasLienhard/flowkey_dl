...
class MainWindow(object):
    def __init__(self,master):
        ...
        self.scale = Scale(layout, from_=10, to=200, orient=HORIZONTAL, command=self.update_preview)
        self.scale.set(100)
        ...
        self.font_sz_title=Scale(layout, from_=10, to=100, orient=HORIZONTAL, command=self.update_preview)
        ...
        self.font_sz_author=Scale(layout,from_=10, to=100, orient=HORIZONTAL, command=self.update_preview)
        ...
        self.space=Scale(layout, from_=10, to=200, orient=HORIZONTAL, command=self.update_preview)
        self.space.set(50)
        ...
        self.apply_b=Button(measure,text="apply",command=lambda x=None: self.update_preview(0))
        ...
        self.prev_scale = Scale(self.prev_scale_frame, from_=10, to=100, orient=HORIZONTAL, command=lambda x=None: self.update_preview(2000))
    ...
    def get_images(self):
        return arange_image(self.image, 
                            self.title.get(), self.artist.get(),
    ...
    def _get_preview(self):
        ...
        self.prev_img=[ImageTk.PhotoImage(i.resize((self.prev_width, self.prev_height))) for i in self.processed_images]
